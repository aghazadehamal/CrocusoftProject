...
export default function ContactSection() {
  return (
    <div className="text-center py-32 bg-gray-100 relative overflow-hidden">
      ...
      <p className="text-2xl tracking-wide leading-10 text-gray-700 max-w-2xl mx-auto mb-6 pl-16 pr-16 mt-5">
        Sizə kömək etmək istərdik! Bizə özünüz və möhtəşəm layihəniz barədə bir az məlumat verin, sizinlə əlaqə saxlayacağıq.
      </p>
      <button className="bg-customPurple text-white py-6 px-12 shadow-lg transition rounded-md tracking-wide text-lg duration-300 mt-10">
        BİZİ SEÇ
      </button>
