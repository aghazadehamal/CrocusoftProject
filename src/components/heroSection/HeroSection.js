  ...
  <WhiteCube size="big" style={{ transform: "translate(-10px, -250px)" }} />
     ...
     <div className="max-w-full px-6 md:px-32">
        <div className="mb-6 flex flex-wrap gap-4 items-center">
          ...
          <span className="text-gray-600 tracking-wide text-lg">
            {translations.hero.sendProjectDesc}
          </span>
          ...
          <span className="text-gray-600 tracking-wide text-lg">
            {translations.hero.presentationDesc}
          </span>
        </div>
    ...
    size="tiny" 
    color="#ebebf2" 
    style={{ transform: "translate(-120px, 420px)" }} 
  /> 
  <WhiteCube 
    size="big" 
    color="#ebebf2" 
    style={{ transform: "translate(30px, -170px)" }} 
  /> 
